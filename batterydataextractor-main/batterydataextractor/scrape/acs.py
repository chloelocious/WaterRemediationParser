# -*- coding: utf-8 -*-
"""
batterydataextractor.scrape.acs

~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~
The American Chemical Society (ACS) web scraper. Please get the permission from RSC before web-scraping.
"""
import re
import requests
...
class ACSWebScraper(BaseWebScraper):
    """
    ACS web-scraper
    """
    ...
    def get_doi(self, afterDate, start, beforeDate):
        """
        ...
        url = "https://search.acs.org/?afterDate={}&start={}&filter_type_include=true&allTerms={}&beforeDate={}".format(
            afterDate, start, self.query, beforeDate,
        )
        driver.get(url)
